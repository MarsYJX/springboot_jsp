...
<div class="modal-dialog" style="margin-top: 10%;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title text-center" id="myModalLabel">老师登陆</h4>
        </div>
        ...
        <div class="modal-footer">
            <div class="form-group">
                <button type="button" onclick="doTeacherLogin()" class="btn btn-primary form-control">登录</button>
            </div>
            <div class="form-group">
                <button type="button" onclick="toTeacherRegisterPage()" class="btn btn-default form-control">注册</button>
            </div>
...
<script type="text/javascript">
    function doTeacherLogin() {
        ...
        //提交表单
        $.ajax({
            url: "${pageContext.request.contextPath}/doTeacherLogin",
            type: "post",
            data: {"t_username": t_username, "t_password": t_password},
    ...
    function toTeacherRegisterPage() {
